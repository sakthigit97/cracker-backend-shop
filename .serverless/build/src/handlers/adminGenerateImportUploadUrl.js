...
// src/handlers/adminGenerateImportUploadUrl.ts
var adminGenerateImportUploadUrl_exports = {};
__export(adminGenerateImportUploadUrl_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(adminGenerateImportUploadUrl_exports);
...
var handler = async (event) => {
  try {
    ...
    const importId = `imp-${(0, import_crypto.randomUUID)()}`;
    const s3Key = `imports/${adminId}/${importId}.xlsx`;
    const command = new import_client_s32.PutObjectCommand({
      Bucket: BUCKET,
      Key: s3Key
    });
    const uploadUrl = await (0, import_s3_request_presigner.getSignedUrl)(s3, command, {
      expiresIn: 300
    });
    return response(200, {
      importId,
...
*/
//# sourceMappingURL=adminGenerateImportUploadUrl.js.map
