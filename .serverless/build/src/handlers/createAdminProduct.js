...
// src/handlers/createAdminProduct.ts
var createAdminProduct_exports = {};
__export(createAdminProduct_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(createAdminProduct_exports);
...
// src/handlers/createAdminProduct.ts
var service = new AdminCreateProductService();
var handler = async (event) => {
  try {
    ...
    if (!productId || !name || !price || !brandId || !categoryId || !searchText || !description) {
      return {
        statusCode: 400,
        body: "productId, name, price, brandId, categoryId, searchText, description are required"
      };
    }
    if (quantity === void 0 || Number(quantity) < 0) {
      return {
        statusCode: 400,
...
*/
//# sourceMappingURL=createAdminProduct.js.map
