...
// src/handlers/getAdminProducts.ts
var getAdminProducts_exports = {};
__export(getAdminProducts_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(getAdminProducts_exports);
...
var AdminProductsRepository = class {
  async fetchProducts(params) {
    ...
    if (brandId) {
      ...
      command = new import_lib_dynamodb2.ScanCommand({
        TableName: TABLE,
        Limit: limit,
        ExclusiveStartKey: cursor
      });
...
// src/services/adminProducts.service.ts
var AdminProductsService = class {
  constructor(repo = new AdminProductsRepository()) {
    this.repo = repo;
  }
...
// src/handlers/getAdminProducts.ts
var service = new AdminProductsService();
...
*/
//# sourceMappingURL=getAdminProducts.js.map
