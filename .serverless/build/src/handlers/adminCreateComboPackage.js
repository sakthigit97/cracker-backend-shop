...
// src/handlers/adminCreateComboPackage.ts
var adminCreateComboPackage_exports = {};
__export(adminCreateComboPackage_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(adminCreateComboPackage_exports);
...
// src/services/adminCreateProduct.service.ts
var AdminCreateProductService = class {
  constructor(repo = new AdminCreateProductRepository()) {
    this.repo = repo;
  }
...
var docClient = import_lib_dynamodb3.DynamoDBDocumentClient.from(client2);
...
var AdminUpdateProductRepository = class {
  ...
  async addPackageTagId(productId, packageTagId) {
    const res = await ddb.send(
      new import_lib_dynamodb4.UpdateCommand({
        TableName: TABLE2,
        Key: { productId },
...
// src/services/adminUpdateProduct.service.ts
var AdminUpdateProductService = class {
  constructor(repo = new AdminUpdateProductRepository()) {
    this.repo = repo;
  }
  async updateProduct(productId, input) {
...
// src/services/adminCreateComboPackage.service.ts
var AdminCreateComboPackageService = class {
  constructor(productService = new AdminCreateProductService(), configService = new AdminConfigService(
    new AdminConfigRepo()
  ), productUpdateService = new AdminUpdateProductService()) {
...
// src/handlers/adminCreateComboPackage.ts
var service = new AdminCreateComboPackageService();
...
*/
//# sourceMappingURL=adminCreateComboPackage.js.map
