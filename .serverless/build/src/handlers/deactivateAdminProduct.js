...
// src/handlers/deactivateAdminProduct.ts
var deactivateAdminProduct_exports = {};
__export(deactivateAdminProduct_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(deactivateAdminProduct_exports);
...
// src/repo/adminDeactivateProduct.repo.ts
...
var AdminDeactivateProductRepository = class {
  async toggleStatus(productId) {
    ...
    const nextStatus = getRes.Item.isActive === "true" ? "false" : "true";
...
// src/services/adminDeactivateProduct.service.ts
var AdminDeactivateProductService = class {
  constructor(repo = new AdminDeactivateProductRepository()) {
    this.repo = repo;
  }
...
// src/handlers/deactivateAdminProduct.ts
var service = new AdminDeactivateProductService();
...
*/
//# sourceMappingURL=deactivateAdminProduct.js.map
