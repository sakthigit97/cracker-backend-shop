...
// src/handlers/adminBulkOrderStatusUpdate.ts
var adminBulkOrderStatusUpdate_exports = {};
__export(adminBulkOrderStatusUpdate_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(adminBulkOrderStatusUpdate_exports);
...
async function handler(event) {
  try {
    ...
    return error(
      e.message || "Unable to update bulk order status."
    );
  }
}
...
*/
//# sourceMappingURL=adminBulkOrderStatusUpdate.js.map
