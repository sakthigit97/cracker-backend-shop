...
var bulkOrder_exports = {};
__export(bulkOrder_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(bulkOrder_exports);
...
async function restoreBulkOrder(event) {
  try {
    ...
    await ddb.send(
      new import_lib_dynamodb8.UpdateCommand({
        TableName: BULK_ORDERS_TABLE,
        Key: {
          orderId,
          meta: "ORDER"
...
*/
//# sourceMappingURL=bulkOrder.js.map
