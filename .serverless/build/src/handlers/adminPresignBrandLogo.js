...
var adminPresignBrandLogo_exports = {};
__export(adminPresignBrandLogo_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(adminPresignBrandLogo_exports);
...
var handler = async (event) => {
  try {
    ...
    const id = brandId || `brand-${(0, import_crypto.randomUUID)()}`;
    const key = `brands/${id}/logo/${(0, import_crypto.randomUUID)()}-${fileName}`;
...
*/
//# sourceMappingURL=adminPresignBrandLogo.js.map
