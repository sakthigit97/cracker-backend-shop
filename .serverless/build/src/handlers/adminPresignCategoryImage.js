...
// src/handlers/adminPresignCategoryImage.ts
var adminPresignCategoryImage_exports = {};
__export(adminPresignCategoryImage_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(adminPresignCategoryImage_exports);
...
var handler = async (event) => {
  try {
    ...
    const id = categoryId || `cat-${(0, import_crypto.randomUUID)()}`;
    const key = `categories/${id}/image/${(0, import_crypto.randomUUID)()}-${fileName}`;
...
*/
//# sourceMappingURL=adminPresignCategoryImage.js.map
