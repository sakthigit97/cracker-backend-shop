...
// src/handlers/getPresignedUrls.ts
var getPresignedUrls_exports = {};
__export(getPresignedUrls_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(getPresignedUrls_exports);
...
async function getPresignedUploads(productId, files) {
  return Promise.all(
    files.map(async (file) => {
      const key = `products/${productId}/images/${(0, import_crypto.randomUUID)()}-${file.name}`;
...
*/
//# sourceMappingURL=getPresignedUrls.js.map
