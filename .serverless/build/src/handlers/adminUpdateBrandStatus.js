...
// src/handlers/adminUpdateBrandStatus.ts
var adminUpdateBrandStatus_exports = {};
__export(adminUpdateBrandStatus_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(adminUpdateBrandStatus_exports);
...
var AdminBrandRepository = class {
  ...
  async createBrand(input) {
    const item = {
      brandId: `brand-${(0, import_crypto.randomUUID)()}`,
  ...
  async updateBrand(brandId, input) {
    await ddb.send(
      new import_lib_dynamodb2.UpdateCommand({
        TableName: TABLE,
        Key: { brandId },
        UpdateExpression: "SET #name = :n, logoUrl = :l, isActive = :a",
  ...
  async updateBrandStatus(brandId, isActive) {
    await ddb.send(
      new import_lib_dynamodb2.UpdateCommand({
        TableName: TABLE,
        Key: { brandId },
...
// src/handlers/adminUpdateBrandStatus.ts
var service = new AdminBrandService();
var handler = async (event) => {
  try {
    ...
    await service.updateBrandStatus(brandId, body.isActive);
    return {
      statusCode: 200,
...
*/
//# sourceMappingURL=adminUpdateBrandStatus.js.map
