...
// src/handlers/adminConfigSliderPresign.ts
var adminConfigSliderPresign_exports = {};
__export(adminConfigSliderPresign_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(adminConfigSliderPresign_exports);
...
var handler = async (event) => {
  try {
    ...
    const sliderId = `slider-${(0, import_crypto.randomUUID)()}`;
    const key = `config/sliders/${sliderId}/${(0, import_crypto.randomUUID)()}-${fileName}`;
...
*/
//# sourceMappingURL=adminConfigSliderPresign.js.map
