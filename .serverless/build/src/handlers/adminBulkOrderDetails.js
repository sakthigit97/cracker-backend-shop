...
// src/handlers/adminBulkOrderDetails.ts
var adminBulkOrderDetails_exports = {};
__export(adminBulkOrderDetails_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(adminBulkOrderDetails_exports);
...
async function handler(event) {
  try {
    ...
    const order = await service.adminGetOrder(
      orderId
    );
...
*/
//# sourceMappingURL=adminBulkOrderDetails.js.map
