...
// src/handlers/adminInvoicePresign.ts
var adminInvoicePresign_exports = {};
__export(adminInvoicePresign_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(adminInvoicePresign_exports);
...
async function getPresignedInvoiceUpload(orderId) {
...
async function handler(event) {
  try {
    ...
    return error(
      e.message || "Unable to generate invoice upload URL."
    );
  }
}
...
*/
//# sourceMappingURL=adminInvoicePresign.js.map
